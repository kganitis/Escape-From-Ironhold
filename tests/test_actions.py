...
class TestLock(TestAction):
    ...
    def test_with_lockpick(self):
        ...
        self.assert_result(LOCKING_TOOL_LOCK_FAIL, ['lock', 'lockpick'])
    ...
    def test_not_a_locking_tool(self):
        self.commands = "take stone", "lock lock stone"
...
# TODO finish incomplete tests, then test objects seperately
