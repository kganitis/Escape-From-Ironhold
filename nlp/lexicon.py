# Allowed vocabulary and grammar that the parser
...
class Lexicon():
    ...
    def remove_stops(self, wordlist):
        # Removes any words that is in the lexicon's stop words set.
        cleaned_list = []
    ...
    def build_verbs_from_file(self, filename=None):
        # Returns a dict full of synonyms from a json file
        if not filename:
            return None
